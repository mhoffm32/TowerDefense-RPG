...
class ProgressBar(pygame.sprite.Sprite):
    def __init__(self, surface):
        ...
        self.current_clock_img = pygame.transform.scale(
            pygame.image.load('Images/Clock.png'), (40, 40))

        self.clock_images = [pygame.transform.scale(
            pygame.image.load('Images/clock4.png'), (38, 38)), pygame.transform.scale(
            pygame.image.load('Images/clock2.png'), (38, 38)), pygame.transform.scale(
            pygame.image.load('Images/clock1.png'), (38, 38)), pygame.transform.scale(
            pygame.image.load('Images/clock3.png'), (38, 38))]
