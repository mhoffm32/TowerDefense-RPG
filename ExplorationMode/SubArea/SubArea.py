...
class SubArea:
    ...
    def generateRoom(self, roomNumber):
        ...
        background_path = backgrounds.get(
            roomNumber, 'Images/backgrounds/brown_stone_floor.png')
        self.background = pygame.image.load(background_path)

        if roomNumber == 0:  # the courtyard
            self.wallGroup.add(
                Wall(0, 0, 35, 700, 'Images/mapObjects/walls/35x700_stone_wall.png'))
            self.wallGroup.add(
                Wall(965, 0, 35, 700, 'Images/mapObjects/walls/35x700_hedge_wall.png'))
            self.wallGroup.add(
                Wall(0, 87, 1000, 38, 'Images/mapObjects/walls/1000x38_hedge_wall.png'))
            self.wallGroup.add(
                Wall(0, 662, 1000, 38, 'Images/mapObjects/walls/1000x38_hedge_wall.png'))

            self.doorGroup.add(
                Door(440, 85, 'Images/mapObjects/door_sprite.png', 1, [500, 500]))
            self.doorGroup.add(
                Door(-10, 330, 'Images/mapObjects/door_side_sprite.png', 6, [820, 350]))
            self.doorGroup.add(
                Door(910, 420, 'Images/mapObjects/door_side_sprite.png', 7, [140, 350]))

            self.furnitureGroup.add(
                Furniture(20, 140, 70, 130, 'Images/mapObjects/plant3.png'))
            self.furnitureGroup.add(
                Furniture(890, 140, 70, 130, 'Images/mapObjects/plant3.png'))

        elif roomNumber == 6:  # the shop
            self.wallGroup.add(
                Wall(0, 0, 35, 700, 'Images/mapObjects/walls/35x700_stone_wall.png'))
            self.wallGroup.add(
                Wall(965, 0, 35, 700, 'Images/mapObjects/walls/35x700_stone_wall.png'))
            self.wallGroup.add(
                Wall(0, 87, 1000, 38, 'Images/mapObjects/walls/1000x38_stone_wall.png'))
            self.wallGroup.add(
                Wall(0, 662, 1000, 38, 'Images/mapObjects/walls/1000x38_stone_wall.png'))

            self.doorGroup.add(
                Door(910, 350, 'Images/mapObjects/door_side_sprite.png', 0, [140, 350]))

            self.furnitureGroup.add(
                Furniture(500, 100, 200, 200, 'Images/mapObjects/empty_shelf.png'))
            self.furnitureGroup.add(
                Furniture(700, 100, 200, 200, 'Images/mapObjects/empty_shelf.png'))
            self.furnitureGroup.add(
                Furniture(150, 200, 200, 200, 'Images/mapObjects/shopkeeper_desk.png'))

        elif roomNumber == 7:  # the immortal tree
            self.wallGroup.add(
                Wall(0, 0, 35, 700, 'Images/mapObjects/walls/35x700_hedge_wall.png'))
            self.wallGroup.add(
                Wall(965, 0, 35, 700, 'Images/mapObjects/walls/35x700_hedge_wall.png'))
            self.wallGroup.add(
                Wall(0, 87, 1000, 38, 'Images/mapObjects/walls/1000x38_hedge_wall.png'))
            ...
            self.doorGroup.add(
                Door(-10, 350, 'Images/mapObjects/door_side_sprite.png', 0, [820, 350]))

            self.furnitureGroup.add(
                Furniture(380, 200, 250, 290, 'Images/mapObjects/tree.png'))

        elif roomNumber == 1:  # maybe add stairs as an obstacle and the entry to the castle
            self.wallGroup.add(
                Wall(215, 440, 565, 30, 'Images/mapObjects/walls/1000x38_stone_wall.png'))
            self.wallGroup.add(
                Wall(-720, 235, 1000, 30, 'Images/mapObjects/walls/1000x38_stone_wall.png'))
            self.wallGroup.add(
                Wall(720, 235, 1000, 30, 'Images/mapObjects/walls/1000x38_stone_wall.png'))
            ...
            self.doorGroup.add(
                Door(350, 660, 'Images/mapObjects/door_sprite.png', 0, [500, 200]))
            self.doorGroup.add(
                Door(440, 85, 'Images/mapObjects/door_sprite.png', 2, [500, 500]))

        elif roomNumber == 2:  # castle entrance
            self.wallGroup.add(
                Wall(350, 0, 35, 700, 'Images/mapObjects/walls/35x700_stone_wall.png'))
            self.wallGroup.add(
                Wall(640, 0, 35, 700, 'Images/mapObjects/walls/35x700_stone_wall.png'))
            self.wallGroup.add(
                Wall(0, 87, 1000, 38, 'Images/mapObjects/walls/1000x38_stone_wall.png'))
            self.wallGroup.add(
                Wall(0, 662, 1000, 38, 'Images/mapObjects/walls/1000x38_stone_wall.png'))
            ...
            self.doorGroup.add(
                Door(440, 660, 'Images/mapObjects/door_sprite.png', 1, [500, 200]))
            self.doorGroup.add(
                Door(440, 85, 'Images/mapObjects/door_sprite.png', 3, [500, 500]))

            self.furnitureGroup.add(
                Furniture(370, 100, 70, 130, 'Images/mapObjects/plant3.png'))
            self.furnitureGroup.add(
                Furniture(370, 300, 70, 130, 'Images/mapObjects/plant3.png'))
            self.furnitureGroup.add(
                Furniture(370, 500, 70, 130, 'Images/mapObjects/plant3.png'))
            self.furnitureGroup.add(
                Furniture(590, 100, 70, 130, 'Images/mapObjects/plant3.png'))
            self.furnitureGroup.add(
                Furniture(590, 300, 70, 130, 'Images/mapObjects/plant3.png'))
            self.furnitureGroup.add(
                Furniture(590, 500, 70, 130, 'Images/mapObjects/plant3.png'))
            ...
            self.doorGroup.add(
                Door(440, 660, 'Images/mapObjects/door_sprite.png', 2, [500, 200]))
            self.doorGroup.add(
                Door(440, 85, 'Images/mapObjects/door_sprite.png', 4, [500, 500]))
            self.doorGroup.add(
                Door(-10, 350, 'Images/mapObjects/door_side_sprite.png', 5, [820, 350]))

            self.furnitureGroup.add(
                Furniture(70, 120, 70, 110, 'Images/mapObjects/plant3.png'))
            self.furnitureGroup.add(
                Furniture(860, 120, 70, 110, 'Images/mapObjects/plant4.png'))
            self.furnitureGroup.add(
                Furniture(860, 240, 70, 110, 'Images/mapObjects/plant3.png'))
            self.furnitureGroup.add(
                Furniture(860, 360, 70, 110, 'Images/mapObjects/plant4.png'))
            self.furnitureGroup.add(
                Furniture(860, 480, 70, 110, 'Images/mapObjects/plant3.png'))
            self.furnitureGroup.add(
                Furniture(40, 260, 70, 60, 'Images/mapObjects/lib_sign.png'))

            self.furnitureGroup.add(
                Furniture(680, 70, 180, 190, 'Images/mapObjects/throne.png'))
            ...
            self.furnitureGroup.add(
                Furniture(400, 100, 200, 200, 'Images/mapObjects/bed_sprite.png'))
            self.furnitureGroup.add(
                Furniture(330, 87, 70, 100, 'Images/mapObjects/dresser_sprite.png'))
            self.furnitureGroup.add(
                Furniture(600, 87, 70, 100, 'Images/mapObjects/dresser_sprite.png'))
            self.furnitureGroup.add(
                Furniture(70, 87, 70, 130, 'Images/mapObjects/plant1.png'))
            self.furnitureGroup.add(
                Furniture(900, 87, 70, 130, 'Images/mapObjects/plant1.png'))

            self.doorGroup.add(
                Door(440, 660, 'Images/mapObjects/door_sprite.png', 3, [500, 200]))
            ...
            self.furnitureGroup.add(
                Furniture(30, 100, 150, 160, 'Images/mapObjects/bookshelf_sprite.png'))
            self.furnitureGroup.add(
                Furniture(180, 100, 150, 160, 'Images/mapObjects/bookshelf_sprite.png'))
            self.furnitureGroup.add(
                Furniture(330, 100, 150, 160, 'Images/mapObjects/bookshelf_sprite.png'))
            self.furnitureGroup.add(
                Furniture(480, 100, 150, 160, 'Images/mapObjects/bookshelf_sprite.png'))
            self.furnitureGroup.add(
                Furniture(630, 100, 150, 160, 'Images/mapObjects/bookshelf_sprite.png'))
            self.furnitureGroup.add(
                Furniture(780, 100, 150, 160, 'Images/mapObjects/bookshelf_sprite.png'))
            self.furnitureGroup.add(
                Furniture(150, 360, 150, 160, 'Images/mapObjects/table_and_chair_sprite.png'))
            self.furnitureGroup.add(
                Furniture(350, 360, 150, 160, 'Images/mapObjects/table_and_chair_sprite.png'))
            self.furnitureGroup.add(
                Furniture(550, 360, 150, 160, 'Images/mapObjects/table_and_chair_sprite.png'))
            self.furnitureGroup.add(
                Furniture(900, 170, 70, 130, 'Images/mapObjects/lamp.png'))

            self.doorGroup.add(
                Door(910, 350, 'Images/mapObjects/door_side_sprite.png', 3, [140, 350]))
    ...
    def generateNPCs(self):
        ...
        self.npcGroup.add(FriendlyCharacter(340, 120, self.screen, [
                          defaultGuardText[0]], self.player, 0, 0, 0, 0, 'Images/npc/castle_guard1.png'))
        ...
        self.npcGroup.add(FriendlyCharacter(700, 400, self.screen, libraryGuardText,
                          self.player, 0, 0, 0, 5, 'Images/npc/castle_guard1.png'))
